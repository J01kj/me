module.exports = {
	...
	adminId: "847535606782230559", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTIyMjI3NTcwMzA5ODMxNDg5Mg.GkqWh0.GYoRbqump8abec5oI7rqdwVWxBRqjjni0_Qtjo", //- Bot's Token
	clientId: process.env.clientId || "1222275703098314892", //- ID of the bot
	clientSecret: process.env.clientSecret || "-j5PUpzCqqOwBT5hB1nLGrA3ZiQdNxUY", //- Client Secret of the bot
	...
	function: createCountdown(message, timeInSeconds, eventName)
};
